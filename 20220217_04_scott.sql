...
--==>>
/*
		VALID	10		1	255	65536	1048576	1
		VALID	10		1	255	65536	1048576	1
		VALID	10		1	255	65536	1048576	1
		VALID	10		1	255	65536	1048576	1
*/
...
DEPT	        TABLE	-- 부서(DEPARTNEBTS) 데이터 테이블
...
※ ORACLE 은 숫자 표현 타입이 한 가지로 통일되어 있다.
 ...
 ※ ORACLE 의 문자 표현 타입
    ...
    2. 문자형 CHAR          → 고정형 크기
              ...
              VARCHAR2(10)  ← '가까이김정용'       10Byte를 초과하므로 입력 불가  
...
SELECT EMPNO AS "사원번호", ENAME "사원명", JOB "직  업", SAL 급여, DEPTNO 사원번호
FROM EMP;
...
-- 이 때, 『AS』는 생략이 가능하다.
-- 또한 『"" 도 생략 가능하다.
-- 하지만, 『""』를 생략할 경우 별칭에 공백은 사용할 수 없게 도니다.
